...
**Hypotheses**
- H₀: พฤติกรรมการเข้าชั้นเรียนของนักเรียนกลุ่มคะแนนสูงมีคะแนนสอบ ไม่แตกต่าง จากนักเรียนกลุ่มคะแนนต่ำ
- H₁: พฤติกรรมการเข้าชั้นเรียนของนักเรียนกลุ่มคะแนนสูงมีคะแนนสอบ แตกต่าง จากนักเรียนกลุ่มคะแนนต่ำ
...
## 🔑 ปัจจัยหลัก (Confirmatory)
ใช้กรอบสมมติฐาน H₀/H₁ และทดสอบด้วย Pearson, Spearman
...
### วิธีการวิเคราะห์
- ใช้ **Pearson correlation** (วัดความสัมพันธ์เชิงเส้น)
- ใช้ **Spearman correlation** (วัดความสัมพันธ์เชิงอันดับ)
...
---
## 🧩 ปัจจัยรอง (Descriptive)
อธิบายด้วยสถิติเบื้องต้น (Mean, Median, SD) และกราฟ

## **6. ค่าความสัมพันธ์ระหว่างการเข้าถึงอินเทอร์เน็ต (Internet_Access) กับคะแนนสอบ (Exam_score)**
...
### Hypothesis
- **H₀:** การเข้าถึงอินเทอร์เน็ต **ไม่สัมพันธ์** กับคะแนนสอบ
- **H₁:** การเข้าถึงอินเทอร์เน็ต **สัมพันธ์** กับคะแนนสอบ

## สถิติเบื้องต้น
| กลุ่ม           | Mean | Median | SD    | n    |
|-----------------|------|--------|-------|------|
| Yes (มีเน็ต)   | 68.21| 69     | 10.45 | 4,512|
| No (ไม่มีเน็ต) | 66.07| 67     | 10.12 | 2,095|

**ผลต่างค่าเฉลี่ย:** ≈ +2.14 คะแนน  
**ผลต่างมัธยฐาน:** ≈ +2 คะแนน

### การตีความ
- Mean และ Median ของกลุ่ม Yes สูงกว่า No → นักเรียนที่มีอินเทอร์เน็ตมีแนวโน้มทำคะแนนสอบสูงกว่า
- ผลต่าง ~2 คะแนน แม้ไม่มาก แต่สอดคล้องกันทั้งค่าเฉลี่ยและมัธยฐาน
