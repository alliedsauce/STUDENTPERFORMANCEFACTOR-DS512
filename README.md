...
|-------|----------------------------|------------------------|-------------------------------------------------|----------------------|--------------------------------------------------------------------|
| 1     | **Internet_Access**  | Low / Medium / High   | Mean และ Median Yes > No                  | **เล็กน้อย**         | นักเรียนที่มีอินเทอร์เน็ตมีแนวโน้มทำคะแนนสอบได้สูงกว่า |
...
### **Recommendation**
#### **1. สร้างแรงจูงใจเชิงบวก**
 -  จัดกิจกรรมในห้องเรียนที่สนุกและหลากหลาย (Active Learning)
 -  ให้รางวัลแก่นักเรียนที่มีการเข้าเรียนอย่างสม่ำเสมอ

#### **2. ปรับบรรยากาศห้องเรียน**
 -  ลดความเครียด เพิ่มกิจกรรมกลุ่ม
 -  ใช้เทคโนโลยี เช่น สื่อดิจิทัล เพื่อทำให้การเรียนไม่น่าเบื่อ

#### **3. ติดตามและช่วยเหลือเชิงสร้างสรรค์**
 -  ใช้ระบบแจ้งเตือนการขาดเรียนควบคู่กับการพูดคุยเชิงให้กำลังใจ
 -  สำรวจสาเหตุการขาดเรียนและแก้ไข เช่น ปัญหาการเดินทางหรืออุปกรณ์เรียน

### **Action Plan**
**ระยะสั้น (1–3 เดือน)**
- ปรับบรรยากาศห้องเรียน โดยจัดกิจกรรม Active Learning อย่างน้อยสัปดาห์ละ 1 ครั้ง
- ใช้สื่อดิจิทัล เช่น วิดีโอสั้น เกมการเรียนรู้ เพื่อเพิ่มความสนุก
- มีระบบติดตามการเข้าเรียน มีการแจ้งเตือนนักเรียนและผู้ปกครองเมื่อขาดเรียนเกิน 2 ครั้งต่อเดือน

**ระยะกลาง (3–6 เดือน)**
- ให้รางวัลนักเรียนที่เข้าเรียนครบตามเกณฑ์
- สำรวจสาเหตุการขาดเรียน เช่น ปัญหาการเดินทางหรืออุปกรณ์ เพื่อหาแนวทางแก้ไข

**ระยะยาว (6–12 เดือน)**
- ผูก Attendance เข้ากับระบบประเมินผล โดยกำหนดให้การเข้าเรียนเป็นส่วนหนึ่งของคะแนนพฤติกรรม
- เพิ่มเทคโนโลยีสนับสนุน เช่น Tablet หรือ Learning Platform
- จัดอบรมครูเพื่อใช้วิธี Active Learning อย่างต่อเนื่อง

### **Impact ที่คาดหวัง**
- อัตราการเข้าเรียนเพิ่ม ≥ 50% ภายใน 6 เดือน
