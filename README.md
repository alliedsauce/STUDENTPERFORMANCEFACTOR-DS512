...
- ใช้ **Pearson correlation** เพื่อวัดความสัมพันธ์เชิงเส้น พร้อมตรวจสอบ p-value
- ใช้ **Spearman correlation** เพื่อวัดความสัมพันธ์เชิงอันดับ (เหมาะกับข้อมูลที่ไม่เป็นเส้นตรงหรือมี outlier)
- ระดับนัยสำคัญ: **α = 0.05**
- เครื่องมือที่ใช้: ใช้ Python คำนวณ correlation และ p-value, ใช้ tableau ในการสร้าง Visualization เพื่อแสดงผลลัพธ์
...
#### การทดสอบสมมติฐาน: ความสัมพันธ์ระหว่างจำนวนชั่วโมงของการศึกษาด้วยตนเองกับคะแนนสอบ
...
##### 📈 Hypothesis Summary 
จากการทดสอบสมมติฐานแบบ Two-tailed (α = 0.05) พบว่า:

| ลำดับ | ปัจจัยหลัก | Pearson r (95% CI) | Spearman ρ | p-value | Decision |
|:--:|---|---|---|---|---|
| 1 | Attendance | **0.5812** (0.5650–0.5970) | **0.6724** | < 0.0001 | **Reject H₀** |
| 2 | Hours_Studied | **0.4456** (0.4260–0.4647) | **0.4810** | < 0.0001 | **Reject H₀** |
| 3 | Previous_Scores | **0.1751** (0.1516–0.1984) | **0.1919** | < 0.0001 | **Reject H₀** |
| 4 | Sleep_Hours | **−0.0170** (−0.0411–0.0071) | **−0.0076** | 0.1671 | **Fail to reject H₀** |
| 5 | Tutoring_Sessions | **0.1565** (0.1329–0.1799) | **0.1639** | < 0.0001 | **Reject H₀** |

จากผลการศึกษาและวิเคราะห์ข้อมูลพบว่า
- **Attendance** มีความสัมพันธ์สูงสุดกับคะแนนสอบ (ทั้ง Pearson และ Spearman) → การเข้าเรียนสม่ำเสมอมีผลต่อผลสัมฤทธิ์ทางการเรียนอย่างชัดเจน
- **Hours_Studied** แสดงแนวโน้มเชิงบวก → การจัดสรรเวลาเรียนรู้เพิ่มเติมช่วยเพิ่มผลการสอบ
- **Previous_Scores** และ **Tutoring_Sessions** มีความสัมพันธ์เชิงบวก แต่ในระดับปานกลาง
- **Sleep_Hours** ไม่มีนัยสำคัญ (p-value > 0.05) → ปัจจัยด้านพฤติกรรมการเรียนรู้มีผลมากกว่าการพักผ่อนในชุดข้อมูลนี้

### **🧩 ปัจจัยรอง**
การวิเคราะห์เชิงพรรณนาโดยเปรียบเทียบค่า Mean และ Median ของคะแนนสอบในแต่ละกลุ่ม พบว่า:
...
จากผลการศึกษาและวิเคราะห์ข้อมูลพบว่า
- **Parental_Involvement** มีแนวโน้มชัดที่สุด → การสนับสนุนจากครอบครัวมีผลต่อผลสัมฤทธิ์ทางการเรียน
- **Family_Income** มีผลในระดับปานกลาง → ปัจจัยเศรษฐกิจอาจส่งผลต่อโอกาสการเรียนรู้
- **ปัจจัยอื่น** เช่น Internet_Access, Extracurricular_Activities, Motivation_Level มีผลเล็กน้อย → อาจเป็นปัจจัยเสริมมากกว่าปัจจัยหลัก
...
| Impact | KPI |
|--------|-----|
| อัตราการเข้าเรียนของนักเรียนกลุ่มคะแนนต่ำเพิ่มขึ้น | ค่าเฉลี่ยจาก 72.34% → 79.57% ภายใน 6 เดือน |
| Self-study โดยรวมเพิ่มขึ้น | ค่าเฉลี่ยจาก 20 ชั่วโมง → 25 ชั่วโมงต่อเดือน |
| คะแนนสอบเฉลี่ย | เพิ่มขึ้นตามแนวโน้มที่พบในข้อมูล |
| Engagement | นักเรียนมีส่วนร่วมในกิจกรรมมากขึ้น |
