...
จากผลการศึกษาและวิเคราะห์ข้อมูลพบว่า การเข้าชั้นเรียน (Attendance) เป็นปัจจัยที่มีความสัมพันธ์กับคะแนนสอบมากที่สุดโดยมีค่าสหสัมพันธ์สูงทั้งแบบ Pearson และ Spearman ซึ่งสะท้อนว่าการเข้าเรียนสม่ำเสมอมีผลต่อผลสัมฤทธิ์ทางการเรียนอย่างชัดเจน
...
| ลำดับ | ปัจจัย                     | รูปแบบกลุ่ม            | ภาพรวมของ Mean/Median                          | ความชัดของแนวโน้ม* | ข้อสรุป 1 บรรทัด                                                   |
|-------|----------------------------|------------------------|-------------------------------------------------|----------------------|--------------------------------------------------------------------|
| 1     | **Internet_Access**  | Low / Medium / High   | Mean และ Median Yes > No                  | **เล็กน้อย**         | นักเรียนที่มีอินเทอร์เน็ตมีแนวโน้มทำคะแนนสอบสูงกว่า |
...
| 4     | **Extracurricular_Activities** | Yes / No          | Mean ของ Yes > No เล็กน้อย, Median เท่ากัน     | **เล็กน้อย**        | เข้าร่วมกิจกรรมมีความเกี่ยวข้องบวกเล็กน้อยต่อคะแนน               |
| 5     | **Parental_Involvement**  | Low / Medium / High   | Mean และ Median เพิ่มตามระดับ                  | **สูงสุด**          | การมีส่วนร่วมของผู้ปกครองมากขึ้น → คะแนนโดยรวมดีขึ้นชัดกว่าอีกปัจจัย |

จากผลการศึกษาและวิเคราะห์ข้อมูลพบว่า การมีส่วนร่วมของผู้ปกครอง (Parental_Involvement) มีแนวโน้มชัดที่สุดต่อคะแนนสอบ โดยทั้งค่าเฉลี่ยและมัธยฐานเพิ่มขึ้นตามระดับการมีส่วนร่วม รองลงมาคือ รายได้ครอบครัว (Family_Income) ซึ่งมีผลในระดับปานกลาง
โดยกลุ่มรายได้สูงมีคะแนนเฉลี่ยและมัธยฐานสูงกว่าเล็กน้อย ส่วน การเข้าร่วมกิจกรรมนอกหลักสูตร (Extracurricular_Activities) และ การเข้าถึงอินเทอร์เน็ต (Internet_Access) มีความสัมพันธ์เชิงบวกเล็กน้อยโดยนักเรียนที่เข้าร่วมกิจกรรมหรือมีอินเทอร์เน็ต
มักได้คะแนนสูงกว่าเล็กน้อย ขณะที่ แรงจูงใจ (Motivation_Level) แม้มีแนวโน้มเพิ่มขึ้นตามระดับ แต่ผลกระทบโดยรวมยังอยู่ในระดับเล็กน้อยเมื่อเทียบกับปัจจัยอื่น ๆ
